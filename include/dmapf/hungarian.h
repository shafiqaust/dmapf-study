...
#ifndef DMAPF_INCLUDE_HUNGARIAN_H_
#define DMAPF_INCLUDE_HUNGARIAN_H_
...
{
public:
	static double solve(const std::vector<std::vector<double>>& DistMatrix, std::vector<int>& Assignment);
